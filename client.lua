...
vRPg = Proxy.getInterface("vrp_vipshopmoney")
...
Citizen.CreateThread(function()
	while true do
		...
		if menu then
			...
			drawtxt("~r~SHOP", 1, 1, 0.500, 0.370, 0.70, 46, 163, 152, 255)
			drawtxt("~o~VIP Bronze - $10000", 1, 1, 0.420, 0.430, 0.70, 46, 163, 152, 255)
			drawtxt("VIP Silver - $20000", 1, 1, 0.580, 0.430, 0.70, 46, 163, 152, 255)
			drawtxt("~y~VIP Gold - $30000", 1, 1, 0.420, 0.500, 0.70, 46, 163, 152, 255)
			drawtxt("~b~VIP Diamond - $40000", 1, 1, 0.580, 0.500, 0.70, 46, 163, 152, 255)
			drawtxt("~g~VIP Emerald - $50000", 1, 1, 0.490, 0.570, 0.70, 46, 163, 152, 255)
			if isCursorInPosition(0.420, 0.430, 0.10, 0.10) and IsControlJustPressed(0, 18) then
				TriggerServerEvent("givebronzem")
			end
			if isCursorInPosition(0.580, 0.430, 0.10, 0.10) and IsControlJustPressed(0, 18) then
				TriggerServerEvent("givesilverm")
			end
			if isCursorInPosition(0.420, 0.500, 0.10, 0.10) and IsControlJustPressed(0, 18) then
				TriggerServerEvent("givegoldm")
			end
			if isCursorInPosition(0.580, 0.500, 0.10, 0.10) and IsControlJustPressed(0, 18) then
				TriggerServerEvent("givediamondm")
			end
			if isCursorInPosition(0.490, 0.570, 0.10, 0.10) and IsControlJustPressed(0, 18) then
				TriggerServerEvent("giveemeraldm")
			end
		end
	end
end)
